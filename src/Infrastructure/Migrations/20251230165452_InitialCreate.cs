        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameTypes = table.Column<int>(type: "integer", nullable: true),
                    X01TypeEnum = table.Column<int>(type: "integer", nullable: true),
                    CricketTypeEnum = table.Column<int>(type: "integer", nullable: true),
                    GameStartTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsCricket = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    TurnOrder = table.Column<string[]>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    X01Average = table.Column<float>(type: "real", nullable: true),
                    RoundCounter = table.Column<int>(type: "integer", nullable: false),
                    isCricket = table.Column<bool>(type: "boolean", nullable: false),
                    PointsPerRound = table.Column<int[]>(type: "integer[]", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPlayers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamPlayers_Matchs_MatchId",
                        column: x => x.MatchId,
                        principalSchema: "Match",
                        principalTable: "Matchs",
                        principalColumn: "Id",
